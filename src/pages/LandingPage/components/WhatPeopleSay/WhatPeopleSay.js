                ...
                <div className="w-full bg-white  px-5 py-16 md:py-24">
                    <div className="w-full max-w-6xl mx-auto">
                        <div className="text-center max-w-xl mx-auto">
                            ...
                            <h3 className="text-2xl mb-5 text-indigo-600 font-bold fnt-sty-nunito">See what people say about us.</h3>
                        ...
                        <div className="-mx-3 grid sm:grid-cols-3 grid-cols-1 gap-4">
                            ...
                            <div className="w-full rounded-lg bg-white border border-gray-200 p-5 text-gray-800 font-light mb-6">
                                <div className="w-full flex mb-4 items-center">
                                    ...
                                    <div className="flex-grow pl-3">
                                        <h6 className="font-bold text-sm uppercase text-gray-600 fnt-sty-nunito">Shalaka Pandey</h6>
                                    </div>
                                </div>
                                <div className="w-full">
                            ...
                            <div className="w-full rounded-lg bg-white border border-gray-200 p-5 text-gray-800 font-light mb-6">
                                <div className="w-full flex mb-4 items-center">
                                    ...
                                    <div className="flex-grow pl-3">
                                        <h6 className="font-bold text-sm uppercase text-gray-600 fnt-sty-nunito">Saloni Bordia </h6>
                                    </div>
                                </div>
                                <div className="w-full">
