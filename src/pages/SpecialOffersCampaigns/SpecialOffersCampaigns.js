...
function SpecialOffersCampaigns(props) {
        ...
        <div>
            ...
            <div class="grid grid-cols-12 gap-4">
                ...
                <div class="col-span-10">
                    <DynamicCampaings hideHeading={true} campaignName={selctedCampaign} DB_PATH={selctedCampaignDB} />
                </div>
            </div>
        </div>
    )
...
export default withRouter(SpecialOffersCampaigns);