            ...
            <section className="text-gray-600 body-font">
                <div className="container px-5 py-8 mx-auto flex flex-wrap items-center">
                    <div className="lg:w-1/2 md:w-1/2 md:pr-16 lg:pr-10 pr-0">
                        ...
                        <p className="mb-3 leading-relaxed fnt-sty-nunito">A savings account is a savings account held by a bank or other financial institution that pays interest. While these accounts often yield a low interest rate, their consistency and dependability make them an excellent choice htmlFor storing cash that you wish to have ready htmlFor short-term needs.</p>
                        <p className="mb-3 leading-relaxed fnt-sty-nunito">Savings plans have some restrictions on how frequently you can withdraw money, but they typically offer excellent flexibility that is ideal htmlFor establishing an emergency fund, saving htmlFor a short-term goal such as buying a car or going on vacation, or simply sweeping the excess cash in your bank account so it can earn more interest elsewhere.</p>
                    </div>
                    <div className="lg:w-1/2 md:w-1/2 bg-gray-100 rounded-lg px-6 py-6 flex flex-col md:ml-auto w-full mt-10 md:mt-0">
                        ...
                        <div className='w-full flex flex-col sm:flex-row justify-between sm:space-x-8'>
                            ...
                            <div className="relative mb-2 w-full">
                                <label htmlFor="lastname" className="leading-7 text-sm font-semibold text-gray-600 fnt-sty-nunito fnt-sty-nunito">Last Name</label>
