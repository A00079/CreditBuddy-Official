                            ...
                            <div className='identityproof flex flex-col justify-start'>
                                ...
                                <div className="p-2 pl-0 w-full">
                                    <div className="h-full flex items-center shadow-xl border-gray-200 border p-4 rounded-lg">
                                        ...
                                        <div className="flex-grow">
                                            <h2 className="text-gray-900 text-sm title-font font-medium">Address Proof: Passport, Driving license, Voter’s ID card, etc.
                                            </h2>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div className="p-2 pl-0 w-full">
                                    <div className="h-full flex items-center shadow-xl border-gray-200 border p-4 rounded-lg">
                                        ...
                                        <div className="flex-grow">
                                            <h2 className="text-gray-900 text-sm title-font font-medium">PAN card <br />
