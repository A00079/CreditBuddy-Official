            ...
            <section className="text-gray-600 body-font">
                <div className="container mx-auto flex px-5 py-2 pb-40 md:flex-row flex-col items-center">
                    ...
                    <div className="lg:flex-grow md:w-1/2 lg:pl-24 md:pl-16 flex flex-col md:items-start md:text-left items-center text-center">
                        ...
                        <p className="mb-3 leading-relaxed">The amount you would receive on a savings account is varied in general. Banks and credit unions can normally increase or lower their savings account rate at any time, with the exception of campaigns that offer a fixed rate until a specific date.</p>
