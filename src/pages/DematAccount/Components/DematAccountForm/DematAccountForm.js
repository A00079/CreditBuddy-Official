            ...
            <section className="text-gray-600 body-font">
                <div className="container px-5 py-8 mx-auto flex flex-wrap items-center">
                    <div className="lg:w-1/2 md:w-1/2 md:pr-16 lg:pr-10 pr-0">
                        <h1 className="title-font sm:text-4xl text-3xl mb-4 font-bold text-indigo-600">DEMAT ACCOUNT
                        </h1>
                        ...
                        <p className="mb-3 leading-relaxed">A demat account is used to store electronic shares and securities of publicly listed firms. You can hold a wide range of investments in a Demat account, including bonds, equity shares, government securities, mutual funds, and exchange traded funds. A Demat account, like a bank account, is either credited or debited when you purchase or sell shares of a company. </p>
                        <p className="mb-3 leading-relaxed">It not only reduces superfluous paperwork, but it also helps to streamline the share trading process. Two institutions, National Securities Depository Limited (NSDL) and Central Depository Services Limited (CDSL), manage all Demat accounts in India (CDSL).</p>
                    </div>
