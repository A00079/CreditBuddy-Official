...
export default function Stepscreditcard() {
    return (
        <>
            <div className="container mx-auto flex w-full mb-7 flex-wrap px-8">
                        ...
                        <div className="lg:w-1/2 md:w-1/2 md:pr-10 md:py-6">
                            <div className="flex relative pb-12">
                                ...
                                <div className="flex-grow pl-4">
                                    ...
                                    <p className="leading-relaxed fnt-sty-nunito">Apply for A Demat Account Online</p>
                                </div>
                            </div>
                            <div className="flex relative pb-12">
                                <div className="h-full w-10 absolute inset-0 flex items-center justify-center">
                                ...
                                <div className="flex-grow pl-4">
                                    ...
                                    <p className="leading-relaxed fnt-sty-nunito">Submit The KYC Details Online</p>
                                </div>
                            </div>
                            <div className="flex relative pb-12">
                                <div className="h-full w-10 absolute inset-0 flex items-center justify-center">
                                ...
                                <div className="flex-grow pl-4">
                                    ...
                                    <p className="leading-relaxed fnt-sty-nunito">Get Your Documents Verified</p>
                                </div>
                            </div>
                            <div className="flex relative pb-12">
                                <div className="h-full w-10 absolute inset-0 flex items-center justify-center">
                                ...
                                <div className="flex-grow pl-4">
                                    ...
                                    <p className="leading-relaxed fnt-sty-nunito">Acquire Beneficiary Owner Identity (BOID)</p>
                                </div>
                            </div>
                            <div className="flex relative">
                                ...
                                <div className="flex-grow pl-4">
                                    ...
                                    <p className="leading-relaxed fnt-sty-nunito">Pitchfork ugh tattooed scenester echo park gastropub whatever cold-pressed retro.</p>
                                </div>
                            </div>
                        </div>
                            ...
                            <div className='identityproof flex flex-col justify-start'>
                                ...
                                <div className="p-2 pl-0 w-full">
                                    <div className="h-full flex items-center shadow-xl border-gray-200 border p-4 rounded-lg">
                                        ...
                                        <div className="flex-grow">
                                            <h2 className="text-gray-900 title-font text-sm font-medium fnt-sty-nunito">Identity Proof (Anyone): A copy of your PAN card with your photo</h2>
                                        </div>
                                    </div>
                                </div>
                                <div className="p-2 pl-0 w-40">
                                ...
                                <div className="p-2 pl-0 w-full">
                                    <div className="h-full flex items-center shadow-xl border-gray-200 border p-4 rounded-lg">
                                        ...
                                        <div className="flex-grow">
                                            <h2 className="text-gray-900 text-sm title-font font-medium">Financial documents: Salaried: Latest three-month salary slip</h2>
                                        </div>
                                    </div>
                                </div>
                            </div>
