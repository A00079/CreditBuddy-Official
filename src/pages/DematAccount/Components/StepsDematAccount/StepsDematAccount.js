                        ...
                        <div className="lg:w-1/2 md:w-1/2 md:pr-10 md:py-6">
                            <div className="flex relative pb-12">
                                ...
                                <div className="flex-grow pl-4">
                                    ...
                                    <p className="leading-relaxed">Apply for A Demat Account Online</p>
                                </div>
                            </div>
                            <div className="flex relative pb-12">
                                <div className="h-full w-10 absolute inset-0 flex items-center justify-center">
                                ...
                                <div className="flex-grow pl-4">
                                    ...
                                    <p className="leading-relaxed">Submit The KYC Details Online</p>
                                </div>
                            </div>
                            <div className="flex relative pb-12">
                                <div className="h-full w-10 absolute inset-0 flex items-center justify-center">
                                ...
                                <div className="flex-grow pl-4">
                                    ...
                                    <p className="leading-relaxed">Get Your Documents Verified</p>
                                </div>
                            </div>
                            <div className="flex relative pb-12">
                                <div className="h-full w-10 absolute inset-0 flex items-center justify-center">
                                ...
                                <div className="flex-grow pl-4">
                                    ...
                                    <p className="leading-relaxed">Acquire Beneficiary Owner Identity (BOID)</p>
                                </div>
                            </div>
                                ...
                                <div className="p-2 pl-0 w-full">
                                    <div className="h-full flex items-center shadow-xl border-gray-200 border p-4 rounded-lg">
                                        ...
                                        <div className="flex-grow">
                                            <h2 className="text-gray-900 title-font text-sm font-medium">Identity Proof (Anyone): A copy of your PAN card with your photo</h2>
                                        </div>
                                    </div>
                                </div>
                                <div className="p-2 pl-0 w-40">
