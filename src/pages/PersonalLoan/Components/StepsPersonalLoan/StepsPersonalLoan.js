                            ...
                            <div className='identityproof flex flex-col justify-start'>
                                ...
                                <div className="p-2 pl-0 w-full">
                                    <div className="h-full flex items-center shadow-xl border-gray-200 border p-4 rounded-lg">
                                        ...
                                        <div className="flex-grow">
                                            <h2 className="text-gray-900 text-sm title-font font-medium">Address Proof: Aadhaar/Passport/ Driving license, Phone bill, electricity bill, Rental agreement & Two recent passport-sized photographs</h2>
                                        </div>
                                    </div>
                                </div>
                                <div className="p-2 pl-0 w-full">
