            ...
            <section className="text-gray-600 body-font">
                <div className="container px-5 py-24 mx-auto">
                    <div className="flex flex-col text-center w-full mb-12">
                        <h1 className="sm:text-3xl text-2xl font-bold title-font mb-4 text-indigo-600">TYPES OF CREDIT CARD</h1>
                    ...
                    <div className="flex flex-wrap -m-2">
                        <div className="p-2 lg:w-1/2 md:w-1/2 w-full">
                            <div className="h-full shadow-xl flex items-center border-gray-200 border p-4 rounded-lg">
                                ...
                                <div className="flex-grow">
                                    <h2 className="text-blue-700 title-font font-bold">Basic Credit Cards</h2>
                                    <p className="text-gray-500 text-sm">This credit card is the best option for individuals who want to experiment with credit cards. You will be given a minimal credit limit based on your income, and you will be able to make purchases with it. There are no additional benefits to using the card for transactions</p>
                                </div>
                            </div>
                        </div>
                        <div className="p-2 lg:w-1/2 md:w-1/2 w-full">
                            <div className="h-full flex items-center border-gray-200 border p-4 rounded-lg">
                                ...
                                <div className="flex-grow">
                                    <h2 className="text-blue-700 title-font font-bold">No Annual Fee Credit Cards</h2>
                                    <p className="text-gray-500 text-sm">A no annual fee credit card is one that does not charge an annual fee for credit card use. It is regarded a base credit or barely above that level, with very little rewards. Individuals who are new to credit card usage or who use the card seldom would choose a credit card with no annual fee</p>
                                </div>
                            </div>
                        </div>
                        <div className="p-2 lg:w-1/2 md:w-1/2 w-full">
                        ...
                        <div className="p-2 lg:w-1/2 md:w-1/2 w-full">
                            <div className="h-full shadow-xl flex items-center border-gray-200 border p-4 rounded-lg">
                                ...
                                <div className="flex-grow">
                                    <h2 className="text-blue-700 title-font font-bold">Cashback Credit Cards</h2>
                                    <p className="text-gray-500 text-sm">Cashback credit cards offer a percentage of the purchase value as cashback anytime you use the card to make a purchase. The bank may also specify criteria such as cashback is only available on gasoline purchases</p>
                                </div>
                            </div>
                        </div>
                    </div>
